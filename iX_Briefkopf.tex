...
% modifiziert Montag, 16. April 2018 02:24 von Leander Jedamus
...
\DeclareNewLayer[
  ...
  contents={\rotatebox[origin=c]{45}{\includegraphics{background.png}}}
]{background}
...
%\AddLayersToPageStyle{scrheadings}{watermark,background,logo}
\AddLayersToPageStyle{scrheadings}{watermark,showtextarea,background}
